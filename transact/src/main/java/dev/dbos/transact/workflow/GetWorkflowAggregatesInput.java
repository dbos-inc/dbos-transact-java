...
public record GetWorkflowAggregatesInput(
    ...
    boolean groupByApplicationName,
    // select metric flags
    boolean selectCount,
    ...
    /**
     * Aggregate only workflows owned by these applications, plus unclaimed ones. Unset covers this
  ...
  public GetWorkflowAggregatesInput withGroupByApplicationName(boolean groupByApplicationName) {
    return new GetWorkflowAggregatesInput(
        groupByStatus,
        groupByName,
        groupByQueueName,
  ...
  public GetWorkflowAggregatesInput withApplicationName(List<String> applicationName) {
    return new GetWorkflowAggregatesInput(
        groupByStatus,
        groupByName,
        groupByQueueName,
