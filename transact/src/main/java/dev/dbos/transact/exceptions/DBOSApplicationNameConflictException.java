...
public class DBOSApplicationNameConflictException extends RuntimeException {
  ...
  public DBOSApplicationNameConflictException(
    ...
    super(
        "%s '%s' is already registered by application '%s' in this system database. %s names must be unique across applications sharing a system database. Either %s, or, if '%s' was renamed to '%s', re-own its rows first with the dbosctl sysdb rename-application command."
