...
public class RecoveryService {
    ...
    /**
     * Starts the background recovery thread for startup workflow recovery.
     * This method will attempt to recover pending workflows in a separate thread.
     */
    public void start() {
    ...
    /**
     * Stops the background recovery thread.
     * This method will signal the thread to stop and wait for it to complete.
     */
    public void stop() {
        stopRequested = true;
