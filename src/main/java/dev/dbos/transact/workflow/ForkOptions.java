...
/**
 * Configuration options for forking workflows. This class is immutable and uses the Builder pattern for construction.
 */
public class ForkOptions {
    ...
    /**
     * Builder class for constructing ForkOptions instances. Provides a fluent interface for setting configuration
     * values.
     */
    ...
    public String toString() {
        return "ForkOptions{" + "forkedWorkflowId='" + forkedWorkflowId + '\'' + ", applicationVersion='"
                + applicationVersion + '\'' + ", timeoutMS=" + timeoutMS + '}';
    }
}
