...
public class InsertWorkflowResult {
    ...
    public InsertWorkflowResult(int recoveryAttempts, String status, String name, String className, String configName,
            String queueName, Long workflowDeadlineEpochMs) {
    ...
    public String toString() {
        return "InsertWorkflowResult{" + "recoveryAttempts=" + recoveryAttempts + ", status='" + status + '\''
                + ", name='" + name + '\'' + ", className='" + className + '\'' + ", configName='" + configName + '\''
                + ", queueName='" + queueName + '\'' + ", workflowDeadlineEpochMs=" + workflowDeadlineEpochMs + '}';
    }
}
