...
public class DBOSQueueDuplicatedException extends DBOSException {
    ...
    public DBOSQueueDuplicatedException(String workflowUUID, String queueName, String deduplicationID) {
        super(QUEUE_DUPLICATED.getCode(), String.format("Workflow %s (Queue: %s, Deduplication ID: %s) is already enqueued.",
    ...
    public String getWorkflowUUID() { return workflowUUID; }
