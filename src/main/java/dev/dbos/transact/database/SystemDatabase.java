...
public class SystemDatabase {
    ...
    public Object recv(String workflowId, int functionId, int timeoutFunctionId, String topic, double timeoutSeconds) {
    ...
    public <T> T callFunctionAsStep(Supplier<T> fn, String functionName) {
        ...
        if (ctx != null && ctx.isInWorkflow()) {
            ...
            try (Connection connection = dataSource.getConnection()) {
                result = stepsDAO.checkStepExecutionTxn(ctx.getWorkflowId(),nextFuncId,functionName,connection);
