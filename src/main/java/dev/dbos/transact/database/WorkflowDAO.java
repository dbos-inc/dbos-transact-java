...
public class WorkflowDAO {
  ...
  public void updateWorkflowStatus(
    ...
    finalOrderedArgs.add(
        workflowID); // This must be the first parameter in the WHERE clause part (for WHERE
    // workflow_uuid = ?)
  ...
  public void cancelWorkflow(String workflowId) throws SQLException {
    ...
    try (Connection conn = dataSource.getConnection()) {
      ...
      String updateSql =
          "UPDATE %s.workflow_status SET status = ?, "
  ...
  private void insertForkedWorkflowStatus(
  ...
  private void copyOperationOutputs(
