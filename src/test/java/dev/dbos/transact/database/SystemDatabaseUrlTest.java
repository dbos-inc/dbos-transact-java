...
public class SystemDatabaseUrlTest {
    ...
    public void testUrlWithMultipleParameters() {
        String originalUrl = "jdbc:postgresql://localhost:5432/dbos_java_sys?user=admin&password=secret&ssl=true";
        String expectedUrl = "jdbc:postgresql://localhost:5432/postgres?user=admin&password=secret&ssl=true";
    ...
    public void testRemoteHostWithCustomPort() {
        String originalUrl = "jdbc:postgresql://db.example.com:5433/production?user=prod&password=secret&sslmode=require";
        String expectedUrl = "jdbc:postgresql://db.example.com:5433/postgres?user=prod&password=secret&sslmode=require";
    ...
    public void testUrlWithSpecialCharactersInParameters() {
        String originalUrl = "jdbc:postgresql://localhost:5432/mydb?user=admin&password=p@ssw0rd!&ssl=true";
        String expectedUrl = "jdbc:postgresql://localhost:5432/postgres?user=admin&password=p@ssw0rd!&ssl=true";
    ...
    public void testUrlWithFragmentCharacters() {
        String originalUrl = "jdbc:postgresql://localhost:5432/mydb?user=admin&options=-c%20search_path=schema1";
        String expectedUrl = "jdbc:postgresql://localhost:5432/postgres?user=admin&options=-c%20search_path=schema1";
