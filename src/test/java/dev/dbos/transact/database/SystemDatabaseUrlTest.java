...
public class SystemDatabaseUrlTest {
  ...
  public void testNullUrl() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> SystemDatabase.createPostgresConnectionUrl(null));
  ...
  public void testEmptyStringUrl() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> SystemDatabase.createPostgresConnectionUrl(""));
