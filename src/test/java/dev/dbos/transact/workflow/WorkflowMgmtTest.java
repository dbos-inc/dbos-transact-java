...
public class WorkflowMgmtTest {
    ...
    static void onetimeSetup() throws Exception {
        ...
        WorkflowMgmtTest.dbosConfig = new DBOSConfig.Builder().name("systemdbtest")
                .url("jdbc:postgresql://localhost:5432/dbos_java_sys").dbUser("postgres").sysDbName("dbos_java_sys")
    ...
    public void testFork() {
        ...
        ForkService forkService = dbos.<ForkService>Workflow().interfaceClass(ForkService.class).implementation(impl)
                .build();
